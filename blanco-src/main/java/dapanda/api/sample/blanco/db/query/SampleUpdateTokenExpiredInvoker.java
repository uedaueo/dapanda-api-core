...
/**
 * [SampleUpdateTokenExpired] トークン情報の有効期限のアップデートを行います。 (QueryInvoker)
 *
 ...
 */
public class SampleUpdateTokenExpiredInvoker {
    /**
    ...
    /**
     * SampleUpdateTokenExpiredInvokerConstructor for the class.
     *
     ...
     */
    public SampleUpdateTokenExpiredInvoker(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public SampleUpdateTokenExpiredInvoker() {
    }

    /**
     * SampleUpdateTokenExpiredInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
     ...
     * @throws SQLException If an SQL exception occurs.
     */
    public void setInputParameter(final String token, final Long expiredAt) throws SQLException {
        if (fStatement == null) {
            prepareStatement();
        }
        ...
        if (expiredAt == null) {
            ...
            fStatement.setLong(index, expiredAt.longValue());
        }
        index++;
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SampleUpdateTokenExpiredInvoker : The resource has not been released by the close() method.";
