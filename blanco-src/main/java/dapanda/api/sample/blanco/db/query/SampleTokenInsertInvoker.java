...
/**
 * [SampleTokenInsert] トークンの登録を行います。 (QueryInvoker)
 *
 ...
 */
public class SampleTokenInsertInvoker {
    /**
    ...
    /**
     * SampleTokenInsertInvokerConstructor for the class.
     *
     ...
     */
    public SampleTokenInsertInvoker(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public SampleTokenInsertInvoker() {
    }

    /**
     * SampleTokenInsertInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SampleTokenInsertInvoker : The resource has not been released by the close() method.";
