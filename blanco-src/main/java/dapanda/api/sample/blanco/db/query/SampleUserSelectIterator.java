...
public class SampleUserSelectIterator {
    ...
    /**
     * SampleUserSelectIteratorConstructor for the class.
     *
     ...
     */
    public SampleUserSelectIterator(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public SampleUserSelectIterator() {
    }

    /**
     * SampleUserSelectIteratorSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
     ...
     * @throws SQLException If an SQL exception occurs.
     */
    public SampleUserSelectRow getRow() throws SQLException {
        SampleUserSelectRow result = new SampleUserSelectRow();
     ...
     *
     * The list will contain the SampleUserSelect class.<br>
     ...
     * @return SampleUserSelectClass List, which will return an empty list if the search results are zero.
     * @throws SQLException If an SQL exception occurs.
     */
    public List<SampleUserSelectRow> getList(final int size) throws SQLException {
        List<SampleUserSelectRow> result = new ArrayList<SampleUserSelectRow>(8192);
