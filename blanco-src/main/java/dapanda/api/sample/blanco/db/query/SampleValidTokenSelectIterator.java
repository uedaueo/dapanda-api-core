...
/**
 * [SampleValidTokenSelect] 有効なトークン情報の取得を行います。 (QueryIterator)
 *
 * Wraps a search-type SQL statement to provide various accessors.<br>
 * Scroll attribute: forward_only<br>
 */
public class SampleValidTokenSelectIterator {
    /**
    ...
    /**
     * SampleValidTokenSelectIteratorConstructor for the class.
     *
     ...
     */
    public SampleValidTokenSelectIterator(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public SampleValidTokenSelectIterator() {
    }

    /**
     * SampleValidTokenSelectIteratorSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
     ...
     * @throws SQLException If an SQL exception occurs.
     */
    public SampleValidTokenSelectRow getRow() throws SQLException {
        SampleValidTokenSelectRow result = new SampleValidTokenSelectRow();
     ...
     *
     * The list will contain the SampleValidTokenSelect class.<br>
     ...
     * @return SampleValidTokenSelectClass List, which will return an empty list if the search results are zero.
     * @throws SQLException If an SQL exception occurs.
     */
    public List<SampleValidTokenSelectRow> getList(final int size) throws SQLException {
        List<SampleValidTokenSelectRow> result = new ArrayList<SampleValidTokenSelectRow>(8192);
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SampleValidTokenSelectIterator : The resource has not been released by the close() method.";
