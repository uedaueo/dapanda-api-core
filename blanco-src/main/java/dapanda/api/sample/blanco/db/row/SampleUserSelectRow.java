 ...
 *
 * 'SampleUserSelectRow' row is represented.
 * (1) 'password' column type:java.lang.String
 */
@io.micronaut.core.annotation.Introspected
public class SampleUserSelectRow {
    /**
     * Field [password].
     *
     * フィールド: [password]。
    ...
    public String toString() {
        ...
        buf.append("dapanda.api.sample.blanco.db.row.SampleUserSelectRow[");
     ...
     */
    public void copyTo(final SampleUserSelectRow target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: SampleUserSelectRow#copyTo(target): argument 'target' is null");
        }
