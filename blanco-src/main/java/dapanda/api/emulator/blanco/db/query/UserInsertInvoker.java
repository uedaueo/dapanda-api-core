...
/**
 * [UserInsert] ユーザーの新規登録を行います (QueryInvoker)
 *
 ...
 */
public class UserInsertInvoker {
    /**
    ...
    /**
     * UserInsertInvokerConstructor for the class.
     *
     ...
     */
    public UserInsertInvoker(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public UserInsertInvoker() {
    }

    /**
     * UserInsertInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "UserInsertInvoker : The resource has not been released by the close() method.";
