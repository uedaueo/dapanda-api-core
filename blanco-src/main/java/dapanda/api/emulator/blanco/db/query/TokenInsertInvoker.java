...
/**
 * [TokenInsert] トークンの登録を行います。 (QueryInvoker)
 *
 ...
 */
public class TokenInsertInvoker {
    /**
    ...
    /**
     * TokenInsertInvokerConstructor for the class.
     *
     ...
     */
    public TokenInsertInvoker(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public TokenInsertInvoker() {
    }

    /**
     * TokenInsertInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
    ...
    public String getQuery() {
        return "INSERT INTO `sample`.`token` (\n`user_id`, \n`token`,\n`expired_at`\n)VALUES(\n?,\n?,\nFROM_UNIXTIME(?)\n);";
    }
     ...
     * @throws SQLException If an SQL exception occurs.
     */
    public void setInputParameter(final String userId, final String token, final Long expiredAt) throws SQLException {
        if (fStatement == null) {
            prepareStatement();
        }
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "TokenInsertInvoker : The resource has not been released by the close() method.";
