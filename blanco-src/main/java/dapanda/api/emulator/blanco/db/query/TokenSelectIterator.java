 ...
 */
package dapanda.api.emulator.blanco.db.query;
...
import dapanda.api.emulator.blanco.db.row.TokenSelectRow;

/**
 * [TokenSelect] トークン情報の取得を行います。 (QueryIterator)
 *
 * Wraps a search-type SQL statement to provide various accessors.<br>
 * Scroll attribute: forward_only<br>
 */
public class TokenSelectIterator {
    /**
    ...
    /**
     * TokenSelectIteratorConstructor for the class.
     *
     ...
     */
    public TokenSelectIterator(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public TokenSelectIterator() {
    }

    /**
     * TokenSelectIteratorSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
     ...
     * @throws SQLException If an SQL exception occurs.
     */
    public TokenSelectRow getRow() throws SQLException {
        TokenSelectRow result = new TokenSelectRow();
     ...
     *
     * The list will contain the TokenSelect class.<br>
     ...
     * @return TokenSelectClass List, which will return an empty list if the search results are zero.
     * @throws SQLException If an SQL exception occurs.
     */
    public List<TokenSelectRow> getList(final int size) throws SQLException {
        List<TokenSelectRow> result = new ArrayList<TokenSelectRow>(8192);
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "TokenSelectIterator : The resource has not been released by the close() method.";
