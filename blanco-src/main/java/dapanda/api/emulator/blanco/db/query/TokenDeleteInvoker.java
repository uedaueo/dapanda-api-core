...
/**
 * [TokenDelete] トークンの削除を行います。 (QueryInvoker)
 *
 * Wraps an executable SQL statement and provides various accessors.<br>
 */
public class TokenDeleteInvoker {
    /**
    ...
    /**
     * TokenDeleteInvokerConstructor for the class.
     *
     ...
     */
    public TokenDeleteInvoker(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public TokenDeleteInvoker() {
    }

    /**
     * TokenDeleteInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "TokenDeleteInvoker : The resource has not been released by the close() method.";
