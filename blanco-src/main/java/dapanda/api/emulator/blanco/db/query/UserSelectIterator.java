...
public class UserSelectIterator {
    ...
    /**
     * UserSelectIteratorConstructor for the class.
     *
     ...
     */
    public UserSelectIterator(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public UserSelectIterator() {
    }

    /**
     * UserSelectIteratorSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
     ...
     * @throws SQLException If an SQL exception occurs.
     */
    public UserSelectRow getRow() throws SQLException {
        UserSelectRow result = new UserSelectRow();
        result.setPassword(fResultSet.getString(1));
     ...
     *
     * The list will contain the UserSelect class.<br>
     ...
     * @return UserSelectClass List, which will return an empty list if the search results are zero.
     * @throws SQLException If an SQL exception occurs.
     */
    public List<UserSelectRow> getList(final int size) throws SQLException {
        List<UserSelectRow> result = new ArrayList<UserSelectRow>(8192);
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "UserSelectIterator : The resource has not been released by the close() method.";
