...
public class TokenSelectRow {
    ...
    public String toString() {
        ...
        buf.append("dapanda.api.emulator.blanco.db.row.TokenSelectRow[");
     ...
     */
    public void copyTo(final TokenSelectRow target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: TokenSelectRow#copyTo(target): argument 'target' is null");
        }
