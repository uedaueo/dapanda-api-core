...
/**
 * [UpdateTokenExpired] トークン情報の有効期限のアップデートを行います。 (QueryInvoker)
 *
 ...
 */
public class UpdateTokenExpiredInvoker {
    /**
    ...
    /**
     * UpdateTokenExpiredInvokerConstructor for the class.
     *
     ...
     */
    public UpdateTokenExpiredInvoker(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public UpdateTokenExpiredInvoker() {
    }

    /**
     * UpdateTokenExpiredInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "UpdateTokenExpiredInvoker : The resource has not been released by the close() method.";
